...
export const all_db_items = [item_wood, item_stick, item_sawmill, item_drill, item_stone, item_coal, item_iron];
...
export const all_db_items_recipes = [...item_stick_recipe, ...item_sawmill_recipe, ...item_drill_recipe];
