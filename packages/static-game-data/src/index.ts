...
export const all_db_items = [item_wood, item_stick, item_sawmill, item_drill, item_stone, item_coal, item_iron, wood_axe, wood_pickaxe];
...
const allTools = [wood_axe_tool, wood_pickaxe_tool];
